...
class Feature1:
    ...
    def run(self):
        ...
        # Plot the chart
        averages.nlargest(top_n).plot(kind='bar', figsize=(14,8), title=f'Top {top_n} Issue Labels with the Longest Discussions', xlabel='Label names', ylabel='Average # of Comments')
        plt.show() 
